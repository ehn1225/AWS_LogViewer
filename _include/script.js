...
function Readfiles(filter = 'non'){
	...
	for (let entry of user_count) {
		log_count.innerHTML += "<li class=\"list-group-item d-flex justify-content-between align-items-center\" onclick=\"Readfiles('" + entry[0] + "')\">" + entry[0] + "<span class=\"badge bg-primary rounded-pill\">" + entry[1] + "</span></li>";	
  	}
	...
	if(filter != 'non'){
		log_count.innerHTML += "<li class=\"list-group-item d-flex justify-content-between align-items-center\" onclick=\"Readfiles()\">필터 적용 취소<span class=\"badge bg-primary rounded-pill\">" + count + "</span></li>";
	}
